...
const Messages = () => {
  ...
  // start polling when needed only
  // useEffect(() => {
  //   if (!selectedConversation) return;

  //   const interval = setInterval(async () => {
  //     try {
  //       await loadMessages(selectedConversation._id, null, 20); // Keep parameters as needed
  //     } catch (err) {
  ...
  return (
    <div>
     ...
     <div className="bg-white rounded-xl shadow-card max-h-screen h-screen flex flex-col sm:flex-row overflow-hidden">
  {/* Sidebar */}
